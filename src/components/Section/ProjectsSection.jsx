  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className={`absolute opacity-5 top-20 left-1/4 w-96 h-96 rounded-full blur-3xl${
            isDarkMode ? "bg-blue-500" : "bg-blue-400"
          }`}
        />
        <div
          className={`absolute opacity-5 bottom-20 left-1/4 w-80 h-80 rounded-full blur-3xl${
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.h2
            variants={itemVariants}
            className="text-3xl font-light mb-6 md:text-5xl"
          >
            Recent
