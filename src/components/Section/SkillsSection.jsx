...
import { SKILLS_CATEGORY, STATS, TECT_STACK } from "../../utlis/data.js";
  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y }} className="absolute inset-0 overflow-hidden">
        <div
          className={`absolute top-40 right-1/4 w-72 h-72 rounded-all blur-3xl opacity-5 ${
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          animate={isInView ? "visible" : "hidden"}
          variants={containerVariants}
          className="grid md:grid-cols-2 gap-8 lg:gap-12 mb-6"
        >
                ...
                {category.skills.map((skill, skillIndex) => (
                  <div key={skill.name} className="group">
                    ...
                    >
                      ...
                      >
                        <div className="absolute inset-0bg-white/20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                      </motion.div>
                    </div>
                  </div>
                ))}
        ...
        >
          <motion.div variants={itemVariants} className="text-center mb-8">
            <h3 className="text-xl font-medium mb-6"> Also Working With</h3>
          </motion.div>
